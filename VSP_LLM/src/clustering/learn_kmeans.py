...
if __name__ == "__main__":
    ...
    parser.add_argument("--feat_dir", type=str,default="/mnt/sdb/yuran/av_hubert/datasets/multivsr/features/from_official_pretrained/Layer_12")
    parser.add_argument("--split", type=str,default="train")
    parser.add_argument("--nshard", type=int,default=1)
    parser.add_argument("--km_path", type=str,default="/mnt/sdb/yuran/av_hubert/datasets/multivsr/km/from_official_pretrained/Layer_12.pkl")
    parser.add_argument("--n_clusters", type=int,default=200)
    parser.add_argument("--seed", default=1, type=int)
    parser.add_argument(
        "--percent", default=0.1, type=float, help="sample a subset; -1 for all"
    )
    parser.add_argument("--init", default="k-means++")
    parser.add_argument("--max_iter", default=100, type=int)
    parser.add_argument("--batch_size", default=10000, type=int)
