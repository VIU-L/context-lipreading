...
DATA_ROOT=/mnt/sdb/yuran/av_hubert/datasets/lrs2/raw/mvlrs_v1/big_data   # path to test dataset dir

MODEL_PATH=/mnt/sdb/yuran/av_hubert/datasets/lrs2/outs_llm6/output_finetune_keywords/checkpoints/checkpoint_best.pt
OUT_PATH=/mnt/sdb/yuran/av_hubert/datasets/lrs2/outs_llm6/output_infer_keywords/  
